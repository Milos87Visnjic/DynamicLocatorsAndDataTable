...
public class DemoPage extends BasePage {
    ...
    public WebElement leaguesSelectionBox;

    @FindBy(css = "div[aria-haspopup='listbox']~input")
    public WebElement selectionBoxVerify;

    @FindBy(xpath = "//span[text()='Regions']/parent::div")
    ...
    public WebElement tiers(String tierName) {
        String css = "button#simple-tab-" + tierName + "";
        return Driver.get().findElement(By.cssSelector(css));
    }
    ...
    /**
     * This method enables to click leagues in hamburger menu
     * @param leaguesName
     */
